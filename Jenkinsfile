...
node {
    def ARTIFACTS_PATH = 'build/repository/com/github/vsergeev/lua-periphery/*'
        ...
        stage("${atEntry[0]} ${atEntry[1]} ${atEntry[2]}"){
            docker.image("${atEntry[3]}").inside('-u root') {
                ...
                checkout([$class: 'GitSCM',
                    ...
                    submoduleCfg: [],
                    userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/com.github.vsergeev-lua-periphery.git']]
                ])
